...
?>
     ...
     <div class="jumbotron text-center">
         ...
         <p>Los productos serán enviados de 24 a 48 horas luego de la facturación<br/>
             <strong> (Para aclaraciones  :emely.cabrera.espinal.06@gmail.com) </strong>
         </p>
         <a href="http://localhost/INKA/index.php" class="btn btn-success" role="button" aria-pressed="true">Listo</a>
     </div>
