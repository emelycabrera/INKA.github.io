...
<table class="table table-light table-bordered">
    ...
    <?php }else{ ?>
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          <a class="dropdown-item" href="plomeria.php">Accesorios</a>
          <a class="dropdown-item" href="electrico.php">Mini Mochilas</a>
          <a class="dropdown-item" href="iluminacion.php">Botellas de Agua</a>
          <a class="dropdown-item" href="carpinteria.php">Mini Abanicos</a>
        </div>
        </div>
    <?php } ?>
